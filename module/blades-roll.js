...
async function showChatRollMessage(r, zeromode, attribute_name = "", position = "", effect = "", note = "", current_stress, current_crew_tier) {
  ...
  // Check for Resistance roll
    ...
    result = await renderTemplate("systems/songs-for-the-dusk/templates/chat/resistance-roll.html", {rolls: rolls, zeromode: zeromode, method: method, roll_status: roll_status, attribute_label: attribute_label, stress: stress, note: note});
  }
  ...
  // Fortune roll if not specified
    ...
    result = await renderTemplate("systems/songs-for-the-dusk/templates/chat/fortune-roll.html", {rolls: rolls, zeromode: zeromode, method: method, roll_status: roll_status, attribute_label: "BITD.Fortune", note: note});
  }
